...
:- gripe_time(40,ensure_loaded(logicmoo(mpred_online/xlisting_web))),if_defined(xlisting_web:ensure_webserver).
...
% DBASE_T System
% ================================================
:- gripe_time(40,ensure_loaded(logicmoo(mpred_online/xlisting_web))).
